...
//      tvStreet.setText("Street: " + street.getStreetName() + ", " + street.getCity());
        ...
        switch (street.getSideOfStreet()) {
            case "A":
                ivSide.setBackgroundResource(R.drawable.ic_side_a);
                break;
            case "B":
                ivSide.setBackgroundResource(R.drawable.ic_side_b);
                break;
        }
    ...
    private String everyDayOfWeek(SelectedDates selectedDates) {
        ...
        switch (dayOfWeekInMon) {
            case 1:
                strDayOfWeekInMon = "1st";
                break;
            case 2:
                strDayOfWeekInMon = "2nd";
                break;
            case 3:
                strDayOfWeekInMon = "3rd";
                break;
            case 4:
